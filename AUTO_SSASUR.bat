...
rem El reporte de Programacion AA (PASO 4b) se baja todos los dias: lo usa
rem programacion_aa.py para la hoja de inventario de cada reinicio de ciclo.
rem (El 14-09-2026 se apago con --no-programacion y se reactivo el mismo dia.)

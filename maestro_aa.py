...
EXCLUIR_ESPECIFICOS_RAW = [
    ...
    # 17/09/2026 (usuario): no se despachan desde Farmacia AT Abierta — fuera de
    # Pedido Fusión y de la hoja de inventario de Bodega AA.
    'AGUA BIDESTILADA MATRAZ 500 ML',
    'AMIODARONA 150 MG/3 ML (50 MG/ML) INYECTABLE',
    'BETAMETASONA FOSFATO DISODICO 4 MG/1ML AM',
    'DEXAMETASONA 4 MG/ML INYECTABLE',
    'FITOMENADIONA 10 MG/ML INTRAMUSCULAR',
    'SODIO BICARBONATO 8,4 % AM 10 ML',
    'SODIO CLORURO 0.9% MATRAZ 500 ML',
    'SOLUCION RINGER LACTATO 500 ML',
    'TERLIPRESINA 1 MG INYECTABLE',
]

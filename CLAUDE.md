...
| `servidor_conteo.py` | Servidor de RED (puerto 8504, stdlib `http.server`, sin dependencias nuevas) para llenar el conteo desde **varias computadoras a la vez** (1 persona por farmacia). Estado compartido en `Conteo_Controlados/estado_compartido.json`; historial vía endpoints atómicos agregar/eliminar. `SERVIDOR_CONTEO_ONLINE.bat` |
